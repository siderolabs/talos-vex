...
#
# Generated on 2025-07-16T09:12:04Z by kres b869533.
...
WORKDIR /src
RUN --mount=type=cache,target=/root/.cache/go-build,id=talos-vex/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=talos-vex/go/pkg govulncheck ./...
