...
#
# Generated on 2025-10-02T13:11:42Z by kres bc281a9.
...
.PHONY: $(ARTIFACTS)/generate-vex-linux-amd64
$(ARTIFACTS)/generate-vex-linux-amd64:
	@$(MAKE) local-generate-vex-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: generate-vex-linux-amd64
generate-vex-linux-amd64: $(ARTIFACTS)/generate-vex-linux-amd64  ## Builds executable for generate-vex-linux-amd64.

.PHONY: generate-vex
generate-vex: generate-vex-linux-amd64  ## Builds executables for generate-vex.
